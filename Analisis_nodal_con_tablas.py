...
with col1:
    ...
    pr = st.number_input("Presión del reservorio (psi)", 300.0, 10000.0, 2000.0, 50.0)
    pb = st.number_input("Presión de burbuja (psi)", 300.0, pr, 1500.0, 50.0)
...
with col2:
    ...
    GOR = st.number_input("Razón gas/petróleo (m3/m3)", 0.0, 2000.0, 200.0)
